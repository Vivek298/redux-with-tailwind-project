...
const Order = ({order}) => {
  ...
  return (
    <div className='container mx-auto py-8 px-4 md:px-16 lg:px-24'>
      ...
      <p>Your Order has been placed successfully you will recive an email confirmation shortly</p>
          ...
          <div className='mt-4'>
           ...
           <div className='mt-4 flex justify-between'>
            ...
            <div className='mt-6'>
             ...
             <button className='bg-red-600 ml-4 text-white py-2 px-4 hover:bg-red-800'
